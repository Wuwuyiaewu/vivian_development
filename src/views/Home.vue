        ...
        <div class="home d-none d-sm-none d-md-block animate">
            <section class="mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-5 col-md-4">get here</div>
            ...
            <div class="container">
                ...
                <div class="col-6 u-padding-8 mb-2">
                    <img src="../assets/pic/Mouse_3.jpg" alt="" class="img-fluid">
                </div>
                ...
                <div class="col-6 u-padding-8 mb-2">
                    <img src="../assets/pic/donut_3.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-6 u-padding-8">
                    <img src="../assets/pic/Rainbow_1.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-6 u-padding-8 mb-2">
                    <img src="../assets/pic/Meringue_1.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-6 u-padding-8">
                    <img src="../assets/pic/cofe_3.jpg" alt="" class="img-fluid">
                </div>
                </div>
            </div>
            <!-- coupon -->
